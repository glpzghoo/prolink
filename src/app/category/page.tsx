        ...
        <div className="p-4">
          ...
          <div className="flex gap-6">
            ...
            <div>
              ...
              <p>
                Өнгөрсөн жил хөгжүүлэлт, IT-тэй холбоотой хийгдсэн гэрээнүүд.
              </p>
            </div>
            <div>
        ...
        <div className="bg-black text-white p-8 rounded-lg flex justify-between items-center">
          <div className="w-1/2">
            ...
            <h1 className="text-3xl font-bold">
              Одоо IT мэргэжилтнүүд ингэж ажиллаж байна
            </h1>
            <p className="mt-2 text-gray-300">
              Бизнесийн хурдаас илүү хурдан хөдлөх уян хатан ажиллах хүчийг бий
              болгоорой.
            </p>
        ...
        <div className="mt-10 flex justify-between items-center p-4">
          <div className="w-1/2">
            ...
            <p className="mt-4 text-gray-600">
              iOS/Android хөгжүүлэгч нь үйлчлүүлэгчийнхээ мөнгө, цаг хугацаа,
              стрессийг хэмнэв
            </p>
            <p className="text-gray-500 mt-2">
              "Igor гар утасны апп хөгжүүлэлтийн өндөр мэдлэгтэй бөгөөд үргэлж
        ...
        <div className="flex gap-4 p-4">
          ...
          <div className="w-1/2 p-4 gap-4">
            <h3 className="text-4xl font-semibold">
              PGA of America шинэ санааг туршихдаа бие даасан хөгжүүлэгчдийг
              ашиглаж байна
            </h3>
          ...
          <div className="w-1/2">
            <div className="border-b-2 p-4 ">
              <p className="font-semibold text-2xl gap-4">
                What is the first step to hiring development and IT talent and
                determining the project cost?
              </p>
              <p className="mt-2">
                One of the first steps in hiring any talent is to determine
                which skills you need for your project. Upwork matches you with
                proven remote talent who can help you with all your development
                and IT needs, including:
              </p>
            </div>
            <div className="border-b-2 p-4">
              <p className="font-semibold text-2xl">
                What are the various ways I can connect with development and IT
                talent through Upwork?
              </p>
              <p className="mt-2">
                Upwork gives you the flexibility you need to find the right
                talent for your development and IT projects.
              </p>
            </div>
            <div className="border-b-2 p-4">
              <p className="font-semibold text-2xl">
                Why should I use Upwork to find talent for development and IT
                services?
              </p>
              <p className="mt-2">
                When it comes to development and IT, you may need a
                multidisciplinary team to handle the various components of your
                project. Examples of professionals you might need for
