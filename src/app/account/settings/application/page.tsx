...
import { job, jobApplication, skill } from '@prisma/client';
...
export default function ProposalDetails() {
  const [applicationData, setApplicationData] = useState<CustomJobApplication[]>([]);
  ...
  const renderStatusMessage = (application: CustomJobApplication) => {
    if (application.cancelled) {
      return role === 'CLIENT' ? 'Талент хүсэлтээ буцаасан байна!' : 'Та хүсэлтээ буцаасан байна!';
    }
    if (role === 'CLIENT') {
                ...
                <div>
                  ...
                  <div className="space-y-3 text-foreground">
                    <div className=" flex gap-2">
                      <strong>Нэр:</strong>{' '}
                      {role === 'CLIENT' ? (
                        <Link target="blank" href={`/freelancer/${application.freelancer.id}`}>
                        ...
                        <Link target="blank" href={`/client/${application.client.id}`}>
                          <div className=" flex gap-1">
                      ...
                      <div className=" flex gap-2">
                        {role === 'CLIENT' && (
                          <>
                            ...
                            <div className=" flex gap-1">
                              <div>
                                {application.freelancer.gender === 'MALE' ? 'Эрэгтэй' : 'Эмэгтэй'}
                              </div>
                            </div>
                          </>
                        )}
                        ...
                        <div className=" flex gap-2">
                          <>
                            ...
                            <div className="flex gap-1">
                              <div>
                                {(() => {
                                  const birthDate = new Date(application.freelancer.birthday);
                    ...
                    <p>
                      <strong>Огноо:</strong> {application.createdAt.split('T')[0]}
                    </p>
                    <p>
                      <strong>Холбоо барих:</strong>{' '}
                      {role === 'CLIENT'
                        ? application.freelancer.email + ', ' + application.freelancer.phoneNumber
                  ...
                  {role === 'CLIENT' ? (
                    <>
                      <div className="flex items-center gap-2">
                        <Select
                          disabled={
                            application.cancelled || application.clientStatus === 'accepted'
                          }
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectGroup>
                              ...
                              <SelectItem
                                value="waiting"
                                disabled={application.clientStatus === 'waiting'}
                              >
                                Хүлээгдэж байна
                              </SelectItem>
                            </SelectGroup>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectGroup>
                            <SelectItem value="true" disabled={application.cancelled}>
                              Хүсэлт буцаах
                            </SelectItem>

                            <SelectItem value="false" disabled={!application.cancelled}>
                              Дахин илгээх
                            </SelectItem>
                          </SelectGroup>
                        </SelectContent>
