...
export default function Navigation() {
  ...
  return (
    <>
      <motion.nav className="fixed top-0 left-0 w-full z-50 bg-background shadow-md px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-around">
        <div>
          <TimeNow />
        </div>
        <div
      ...
      <div className="h-16 sm:h-20 lg:h-24 bg-background" />
    </>
  );
}
