        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-3 lg:gap-10">
          {footerLinks.map((section, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h1 className="font-semibold text-lg sm:text-xl tracking-tight">{section.title}</h1>
              <Accordion type="single" collapsible className="w-full space-y-1 sm:space-y-2">
