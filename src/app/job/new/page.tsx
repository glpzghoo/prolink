        ...
        <div>
          ...
          <Select>
            ...
            <SelectContent>
              ...
              <SelectItem value="Web Development Consultation">Web Development Consultation</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div>
          ...
          <Card className="px-4">
            ...
            <Select>
              <SelectTrigger className="">
                <SelectValue className="text-xs" placeholder="Ур чадваруудаа сонгоорой!" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="Web Design">Graphic Design</SelectItem>
                <SelectItem value="UX/UI">UX/UI</SelectItem>
