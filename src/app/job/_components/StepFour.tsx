	...
	return (
		<div className="max-w-3xl mx-auto p-6">
			<h2 className="text-2xl font-semibold">
				Дараах ажлын хүрээг тооцоолно уу.
			</h2>
			<p className="text-gray-600 mb-4">
				Эдгээр нь эцсийн үр дүн биш бөгөөд таны хэрэгцээнд тохирох зөв хүнийг
				олоход тусална.
			</p>
			...
			<Card className="mb-6">
				<CardContent className="p-4 space-y-3">
					...
					<RadioGroup value={duration} onValueChange={setDuration}>
						...
						>
							<RadioGroupItem id="more-than-6" value="more than 6 months" />{" "}
							<span>6 сараас дээш</span>
						</Label>
						<Label htmlFor="3-6" className="flex items-center space-x-2">
							<RadioGroupItem id="3-6" value="3-6 months" />{" "}
							<span>3-6 сар</span>
						</Label>
						<Label htmlFor="1-3" className="flex items-center space-x-2">
							<RadioGroupItem id="1-3" value="1-3 months" />{" "}
							<span>1-3 сар</span>
						</Label>
					</RadioGroup>
				</CardContent>
			...
			<Card className="mb-6">
				<CardContent className="p-4 space-y-3">
					<h3 className="font-medium">
						Энэ ажил бүтэн цагийнх болох боломжтой юу?
					</h3>
