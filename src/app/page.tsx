		...
		<div>
			...
			<div className="max-w-[1280px] w-full mx-auto mb-20 bg-green-50 p-6 md:p-10 rounded-2xl flex flex-col lg:flex-row items-center shadow-lg">
				...
				<div className="w-full lg:w-1/2 lg:pl-10 mt-6 lg:mt-0 text-center lg:text-left">
					<h2 className="text-2xl md:text-3xl font-bold">
						Маш хялбараар ажлын үр дүнгээ дээшлүүл
					</h2>
					...
					<div className="mt-6 space-y-4">
						{[
							...
							{
								title:
									"Ажлын байрны зар тавьж, шилдэг мэргэжилтнүүдийг ажилд ав.",
								description:
									"Мэргэжилтэн хайх нь маш амархан. Та ажлын зараа оруулаахад л хангалттай",
							},
							{
								title:
									"Санхүүгийн хүндрэлгүйгээр хамгийн сайн мэргэжилтнүүдтэй ажилла",
								description:
									"Өөрийн төсөлдөө хамгийн тохиромжтой гүйцэтгэгчийг сонгоорой.",
							},
						].map((item, index) => (
					...
					<div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center md:items-start px-6 sm:px-12 py-12 text-white text-center md:text-left">
						...
						<div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-3xl">
							{[
								...
								{
									title: "Мэргэжилтэн хайж, хөлслөх",
			...
			<div className="relative max-w-[1280px] w-full mx-auto mb-20 rounded-2xl overflow-hidden shadow-lg flex flex-col md:flex-row">
				...
				<div className="relative w-full md:w-1/2 h-auto md:h-[600px] bg-blue-600 bg-opacity-90 flex flex-col justify-center px-6 sm:px-12 py-12 text-white">
					...
					<p className="mt-4 text-lg max-w-lg">
						Таныг бүтээлчээр ажиллахад түлхэц өгөх үйлчлүүлэгчидтэй хамтран
						ажиллаж,
						<br className="hidden sm:block" /> карьер эсвэл бизнесийнхээ
						хөгжлийг шинэ түвшинд гаргаарай.
					</p>
